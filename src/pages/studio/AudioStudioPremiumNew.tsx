      ...
      <header className="h-14 border-b border-white/10 px-4 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-3">
          <Badge className="bg-violet-500/20 text-violet-400 border-violet-500/30">
            <Mic className="w-3 h-3 mr-1" /> Audio Studio
          </Badge>
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-6 relative">
          <div className="w-full max-w-3xl">
            ...
            <div className="w-full h-64 relative mb-6">
              ...
              {!isRecording && (
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-32 h-32 rounded-full bg-violet-500/10 animate-pulse flex items-center justify-center">
                    <Mic className="w-12 h-12 text-violet-400/50" />
                  </div>
                </div>
              )}
            </div>
            ...
            <p className="text-center text-sm text-white/40 mb-8">
              {isRecording ? (isPaused ? "Recording paused" : "Recording in progress...") : "Press record to begin"}
            </p>
            ...
            <div className="flex items-center justify-center gap-3 p-3 rounded-2xl bg-white/5 border border-white/10">
              ...
              <div className="flex items-center gap-2">
                {!isRecording ? (
                  <Button
                    onClick={() => { setIsRecording(true); setRecordingTime(0); setAudioLevels([]); }}
          ...
          <AnimatePresence>
            {clipNotification && (
              ...
              >
                ...
                <span className="text-white font-medium">Clip Candidate Detected</span>
              </motion.div>
            )}
          </AnimatePresence>
        </main>
