      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-white">Events & Town Halls</h2>
            <Dialog open={showEventDialog} onOpenChange={setShowEventDialog}>
              ...
              <DialogContent className="bg-[#1e3a5f] border-white/10 text-white">
                <DialogHeader>
                  <DialogTitle>Create Campaign Event</DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  <div>
                    <label className="text-sm text-white/60 mb-1 block">Event Title *</label>
                    <Input
                  ...
                  <div className="flex items-center justify-between">
                    <label className="text-sm text-white/80">Virtual Event?</label>
                    <Switch
                  ...
                  {eventForm.is_virtual ? (
                    <div>
                      <label className="text-sm text-white/60 mb-1 block">Virtual Link</label>
                      <Input
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        {event.is_virtual && (
                          <Badge className="mt-2 bg-blue-500/20 text-blue-400">Virtual</Badge>
                        )}
                      </div>
                    </div>
                  </CardContent>
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-white">Email & Message Drafts</h2>
          </div>
          ...
          <Card className="bg-white/5 border-white/10">
            ...
            <CardContent className="space-y-4">
              <div>
                <label className="text-sm text-white/60 mb-1 block">Recipient Group</label>
              ...
              <div>
                <label className="text-sm text-white/60 mb-1 block">Subject Line (optional)</label>
                <Input
              ...
              <div>
                <label className="text-sm text-white/60 mb-1 block">What's the purpose of this email?</label>
                <Textarea
              ...
              {generatedEmail && (
                <div className="space-y-3 pt-4 border-t border-white/10">
                  ...
                  <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                    <p className="text-white/90 whitespace-pre-wrap text-sm">{generatedEmail}</p>
                  </div>
                </div>
              )}
            </CardContent>
