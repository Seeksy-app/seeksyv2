...
export const SEEKSY_MODULES: SeeksyModule[] = [
  // Creator Studio Group
  {
    ...
    integrations: ["ai-clips", "ai-post-production", "media-library", "video-editor", "podcasts"],
  ...
  },
  {
    ...
    isNew: true,
    isAIPowered: true,
    integrations: ["studio", "media-library", "ai-post-production", "podcasts"],
  ...
  },
  {
    ...
    primaryGroup: "creator-studio",
    isAIPowered: true,
    integrations: ["studio", "ai-clips", "media-library", "podcasts"],
  ...
  },
  {
    ...
    route: "/studio/media",
    primaryGroup: "creator-studio",
    integrations: ["studio", "ai-clips", "ai-post-production", "video-editor"],
  ...
  },
  {
    ...
    route: "/studio/editor",
    primaryGroup: "creator-studio",
    integrations: ["studio", "media-library", "ai-clips"],
  ...
  },
  {
    ...
    isNew: true,
    isAIPowered: true,
    integrations: ["studio", "ai-post-production", "identity"],
  ...
  // Podcasting Group
  {
    ...
    integrations: ["studio", "ai-clips", "ai-post-production"],
  ...
  // Campaigns Group
  {
    ...
    integrations: ["email", "newsletter", "automations", "sms"],
  ...
  },
  {
    ...
    route: "/email/inbox",
    primaryGroup: "campaigns",
    integrations: ["campaigns", "automations", "contacts"],
  ...
  },
  {
    ...
    route: "/newsletter",
    primaryGroup: "campaigns",
    integrations: ["campaigns", "email", "blog", "contacts"],
  ...
  },
  {
    ...
    primaryGroup: "campaigns",
    integrations: ["campaigns", "email", "sms", "contacts"],
  ...
  // Events Group
  {
    ...
    route: "/events",
    primaryGroup: "events",
    integrations: ["meetings", "forms", "polls", "awards"],
  ...
  },
  {
    ...
    primaryGroup: "events",
    integrations: ["events", "contacts", "email"],
  ...
  },
  {
    ...
    route: "/forms",
    primaryGroup: "events",
    integrations: ["events", "contacts", "automations"],
  ...
  },
  {
    ...
    route: "/polls",
    primaryGroup: "events",
    integrations: ["events", "email", "newsletter"],
  ...
  },
  {
    ...
    route: "/awards",
    primaryGroup: "events",
    integrations: ["events", "forms", "email"],
  ...
  // CRM & Business Group
  {
    ...
    integrations: ["contacts", "deals", "proposals", "tasks"],
  ...
  },
  {
    ...
    route: "/audience",
    primaryGroup: "crm-business",
    integrations: ["crm", "email", "campaigns"],
  ...
  },
  {
    ...
    primaryGroup: "crm-business",
    integrations: ["tasks", "crm", "contacts"],
  ...
  },
  {
    ...
    route: "/tasks",
    primaryGroup: "crm-business",
    integrations: ["project-management", "crm"],
    bgGradient: "bg-gradient-to-br from-violet-100 via-purple-50 to-fuchsia-100",
    iconBg: "bg-white shadow-lg",
  ...
  },
  {
    ...
    route: "/proposals",
    primaryGroup: "crm-business",
    integrations: ["crm", "deals", "contacts"],
  ...
  },
  {
    ...
    route: "/sales/deals",
    primaryGroup: "crm-business",
    integrations: ["crm", "contacts", "proposals"],
  ...
  // Identity & Profile
  {
    ...
    category: "identity",
    route: "/profile/edit",
    integrations: ["social-analytics", "podcasts", "blog"],
  ...
  // AI Tools (standalone)
  {
    ...
    isNew: true,
    isAIPowered: true,
    integrations: ["studio", "campaigns", "meetings"],
  ...
  },
  {
    ...
    isAIPowered: true,
    isNew: true,
    integrations: ["automations", "campaigns", "email"],
  ...
  // Analytics
  {
    ...
    integrations: ["my-page", "campaigns"],
    bgGradient: "bg-gradient-to-br from-blue-100 via-indigo-50 to-violet-100",
    iconBg: "bg-white shadow-lg",
    iconColor: "text-blue-600",
  },
  {
    ...
    category: "analytics",
    route: "/social-analytics",
    integrations: ["social-analytics", "contacts"],
    bgGradient: "bg-gradient-to-br from-emerald-100 via-green-50 to-teal-100",
    iconBg: "bg-white shadow-lg",
    iconColor: "text-emerald-600",
  },
  {
    ...
    category: "analytics",
    route: "/integrations",
    integrations: ["social-analytics", "audience-insights"],
  ...
  // Audience Segments
  {
    ...
    integrations: ["contacts", "campaigns", "email"],
